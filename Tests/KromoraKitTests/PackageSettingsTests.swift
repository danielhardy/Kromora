...
final class PackageSettingsTests: XCTestCase {
    ...
    /// Every target, not just the library. `KromoraKit` was clean before this step; the executable and
    ...
    func testEveryTargetIsInSwift6LanguageMode() throws {
        ...
        XCTAssertEqual(
            declared, 3,
            """
            All three targets — KromoraKit, Kromora, KromoraKitTests — must declare Swift 6 language mode. \
        ...
        for target in ["KromoraKit", "Kromora", "KromoraKitTests"] {
