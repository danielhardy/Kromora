...
final class LUTLibrary: ObservableObject {
    ...
    init(
        ...
        self.userLookFolderURL = userLookFolderURL ?? KromoraSettings.defaultUserLookFolderURL()
    ...
    private func migrateLegacyPreferences() {
        guard preferences.object(forKey: Self.importedBookmarksKey) == nil,
              let value = preferences.object(forKey: Self.legacyImportedBookmarksKey) else { return }
