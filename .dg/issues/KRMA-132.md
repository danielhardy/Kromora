...
updated: 2026-09-10T12:53:41.877Z
parent: KRMA-124
order: 8xeornae
board: product
commits:
...
tickets (KRMA-107, KRMA-121, and now KRMA-124's verification pass). Reproduced directly: running
the test alone 3x in a row on the pre-KRMA-124 parent commit (955cc36, in a scratch worktree)
failed 1 of 3 runs with the same assertion — "reopening Crop must render the full source stage,
not the already-cropped committed frame" — confirming it predates and is independent of KRMA-124's
