...
updated: 2026-09-09T01:43:53.544Z
order: a0
board: product
commits:
  - cacded2
...
- Keep the existing guards (assetID/sourceRevision fence before the engine call, editor-lane background priority, 350ms delay); consider suppressing prefetch entirely while a mask refinement (LUMO-293) is in flight.
