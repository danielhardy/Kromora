...
updated: 2026-09-07T15:02:02.546Z
order: a0
board: product
verification_report:
  verdict: pass
...
Summary: Verified: CIColorKernel destCoord() fix eliminates the tiled vignette seam; full suite (931 tests) and release build pass. Filed LUMO-277 as a non-blocking follow-up: grainKernel shares the same samplerCoord pattern and may need the same treatment.
