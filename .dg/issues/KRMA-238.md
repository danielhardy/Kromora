...
updated: 2026-09-10T12:53:49.673Z
depends_on:
  - KRMA-251
order: zzq
board: product
...
Use KRMA-201 as the product/UI context and the provider work in KRMA-184, KRMA-187, KRMA-188,
KRMA-189, KRMA-191, and KRMA-224 as the implementation seams. Reuse the existing debug labels and
...
Correctness — BLOCKER (filed as KRMA-251, urgent, parent KRMA-238, depends_on wired):
...
KRMA-238 acceptance criterion that the UI communicate retry states "without freezing the masking
