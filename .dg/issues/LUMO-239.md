...
This is a follow-up to the overlay foundation in LUMO-217 and the prior functional-alpha work in
LUMO-229: verify the current behavior rather than assuming the existing seam is complete. Keep the
