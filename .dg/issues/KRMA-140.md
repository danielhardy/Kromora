...
updated: 2026-09-10T12:53:42.395Z
order: 9i56mgnu
board: product
---
...
`ebec8e8` (KRMA-134) made export requests use `ExportSizing.outputSize(for:)` as the
...
- [ ] The existing KRMA-134 regression tests (100×50 exact case, 3333×5000 fractional case,
      small-source no-upscale case) still pass.
- [ ] No accidental upscaling is introduced.

## Provenance

Found during KRMA-134 counterpoint verification (2026-09-02). KRMA-134 is being sent back to
