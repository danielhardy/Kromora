...
updated: 2026-09-09T08:49:17.491Z
estimate: 8
order: a0
board: product
commits:
...
- Benchmark (informational, never gating): `.decode` interval for the large-JPEG fixture, Release build, same machine, before/after in the agent log (use the LUMO-057 harness if it exists).
