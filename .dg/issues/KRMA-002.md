...
updated: 2026-09-10T12:53:34.680Z
depends_on:
  - KRMA-060
estimate: 5
order: gez4w956
...
(KRMA-060) for stale paths in two living docs.
...
- `docs/ENGINEERING_GUIDE.md`, `docs/ENGINEERING_GUIDE.md` — the living-doc gap already filed as **KRMA-060**
  ...
  with both acceptance criteria checked. Not a blocker for this issue: KRMA-002's own scope
...
No new findings, no unresolved blockers. No child tickets needed (KRMA-060 already covers the one
...
Clearing claim and moving to `done` via `dg issue move` (per KRMA-060's established note in this
