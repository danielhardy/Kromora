...
updated: 2026-09-10T12:53:40.207Z
depends_on:
  - KRMA-095
order: l61q7hh3
board: product
...
Restore export-format stickiness that the KRMA-095 toolbar removal (b38d394) dropped.

## Context

Before KRMA-095, `ExportCoordinator.format` was a `@Published` property, so a format chosen once
...
Found during independent verification of KRMA-095 (b38d394); not a blocker for that issue (its
