...
updated: 2026-09-10T12:53:52.988Z
order: a0
board: product
---
...
![Brush interaction failure evidence](../assets/KRMA-279-brush-black-canvas.png)

This is a follow-up regression against the durable brush/erase behavior delivered in KRMA-223 and
the overlay/presentation fixes in KRMA-239 and KRMA-275; verify those seams before changing them.
...
or pointer-time persistence. Reuse the KRMA-217 performance budgets where applicable and ensure
