...
updated: 2026-09-10T12:53:43.789Z
parent: KRMA-155
order: yzpmr2fr
board: product
---
...
Found while independently verifying KRMA-155: `scripts/agent-worktree.sh create HEAD`
followed by `swift build` fails with multiple errors, none related to KRMA-155:
...
this call site was committed in `b989c0b` ("KRMA-150: bundle licensed starter
...
`d67e322` (KRMA-155). Every "swift build" / "swift test" success claimed in
...
hasn't been caught (see also [[KRMA-160]] which found the parallel Settings-UI
...
referenced in [[KRMA-160]] — the fix is likely to land as part of committing that
