...
updated: 2026-09-09T05:17:55.858Z
estimate: 5
order: a0
board: product
---
...
- Benchmark (informational, never gating): `.photoSwitch` cold-open interval for edited + unedited photos, Release build, same machine/dataset, before/after in the agent log (use the LUMO-057 harness if it exists).
