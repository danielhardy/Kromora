...
`AutoLightSceneSignals.exposure`, introduced in commit `7e990f07`, predates LUMO-207) builds the
...
LUMO-207 counterpoint verification; out of that ticket's scope (pre-existing, unrelated to the
