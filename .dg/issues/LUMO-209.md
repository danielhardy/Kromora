...
fallback when richer photo analysis is unavailable. This is a follow-up to LUMO-149 and the
subject-aware analysis work in LUMO-181/LUMO-200.
...
- Preserve LUMO-149's deterministic, undoable semantics and LUMO-200's richer analysis when it is
