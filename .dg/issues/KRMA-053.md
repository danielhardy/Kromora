...
updated: 2026-09-10T12:53:37.259Z
depends_on:
  - KRMA-052
  - KRMA-015
estimate: 5
...
- `dg validate` — OK (pre-existing pickup-model and KRMA-050 context warnings only).
