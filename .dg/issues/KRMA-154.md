...
updated: 2026-09-10T12:53:43.308Z
order: axzf9i3g
board: product
---

Parent: KRMA-144 (verification finding, non-blocking)

## Context

KRMA-144 (3059ae3) added `LookInspectorEmptyState` with a full presentation matrix (scanning,
...
required to block KRMA-144 — the enum-level presentation matrix already keeps the state/copy
