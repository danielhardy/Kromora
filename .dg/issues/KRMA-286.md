...
updated: 2026-09-10T12:53:53.568Z
order: a0
board: product
---
...
- git diff --check b2ecd8d~1 b2ecd8d (clean)
Findings:
- Minor maintainability nit: PreviewView.swift re-checks inspectorState.isPresented and inspectorState.tab == .masking redundantly alongside viewModel.isMaskingWorkspaceActive, which already includes both conditions. Non-blocking; filed as KRMA-287 (verification, depends on KRMA-286).
Fixes:
- None
Verification commits:
- None
