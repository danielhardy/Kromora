...
updated: 2026-09-10T12:53:36.376Z
depends_on:
  - KRMA-024
estimate: 8
order: 2lb8co6i
...
- `dg validate`: OK (only pre-existing, unrelated warnings — agents.pickup.runner model name, KRMA-035 context completeness).
...
- No UI wiring for these controls yet — confirmed intentional: KRMA-039 (Effects inspector) depends on this issue and is scoped to expose Texture/Clarity/Dehaze in the UI.
