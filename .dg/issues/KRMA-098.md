...
updated: 2026-09-10T12:53:39.771Z
depends_on:
  - KRMA-041
  - KRMA-085
order: mlvyuiwp
...
single Look surface from KRMA-085; do not trade away current GPU-backed rendering.
...
- `swift test` (full suite) — 549 executed, 26 skipped, 0 failures. (Count differs slightly from the implementer's reported 545 because KRMA-099 landed additional tests since; no KRMA-098-related failures.)
