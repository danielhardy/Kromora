...
LUMO-224 gave `PhotoAnalysisCoordinator.performMask` (`PhotoAnalysisCoordinator.swift`) its own
...
but it is a second, independently maintained implementation of the same composition that LUMO-224's
