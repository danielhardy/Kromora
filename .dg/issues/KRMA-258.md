...
updated: 2026-09-10T12:53:51.316Z
depends_on:
  - KRMA-250
order: yh
board: product
...
Working-tree diff (uncommitted, on top of KRMA-246/247/250):
...
- public-surface inspection — no public EditDocumentStore or AppViewModel.editStore
Findings:
- Full-suite failures are outside KRMA-258: PreviewCutoverTests.testOpeningStoredEditsSpeculatesThenSubmitsTheStoredDocument and ThumbnailSwitchLifecycleTests.testEditedThumbnailUsesCurrentDocumentAndIsSharedByBrowsingSurfaces fail when isolated and are already tracked as later preview/thumbnail lifecycle work.
Fixes:
- None
