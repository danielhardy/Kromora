...
updated: 2026-09-10T12:53:50.733Z
parent: KRMA-238
order: j0ad8xbo
board: product
commits:
...
Found during counterpoint verification of KRMA-238 (commit c0aed13), which added production
...
- If `smartMaskRetryKind` is currently `nil` (the common case — no prior top-level smart-mask
  ...
  effectively frozen for that control, which directly contradicts KRMA-238's acceptance criterion
