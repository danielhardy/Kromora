...
updated: 2026-09-10T12:53:54.897Z
estimate: 8
order: a0
board: product
commits:
...
- Benchmark (informational, never gating): preview render interval on a tight crop of a 40MP+ file, Release build, same machine/dataset, before/after in the agent log (use the KRMA-057 harness if it exists).
