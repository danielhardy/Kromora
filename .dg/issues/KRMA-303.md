...
updated: 2026-09-10T12:53:54.979Z
estimate: 8
order: w
board: product
commits:
...
- Benchmark (informational, never gating): interactive tick p50/p95 with histogram + comparison + prefetch active, Release build, same machine/dataset, before/after in the agent log (use the KRMA-057 harness if it exists).
