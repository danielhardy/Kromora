...
updated: 2026-09-10T12:53:48.542Z
depends_on:
  - KRMA-221
  - KRMA-222
  - KRMA-223
...
- dg validate
- git diff --check
- swift test --disable-sandbox (873 executed, 42 skipped, 23 pre-existing baseline failures tracked by KRMA-231)
Findings:
- Full-suite failures are pre-existing and unrelated to KRMA-225; the focused masking lane passes with zero failures.
Fixes:
- None
