...
updated: 2026-09-10T12:53:39.825Z
depends_on:
  - KRMA-047
  - KRMA-049
order: phkg4lrx
...
- `swift test` (full suite) — 557 executed, 26 skipped, 0 failures. (Count differs from the implementer's reported 549 because KRMA-101 landed additional tests since; no KRMA-099-related failures.)
...
- Side-by-side availability gate (`isComparisonAvailable`) from KRMA-047 is preserved and reused consistently for the toolbar control, status bar hint, and Space handling.
