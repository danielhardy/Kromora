...
updated: 2026-09-10T12:53:49.032Z
parent: KRMA-221
order: kg4lvyra
board: product
commits:
...
Discovered during KRMA-221 counterpoint verification. `swift build` is clean and the issue's
...
full suite against the parent commit (21aee1d, pre-KRMA-221) in a scratch worktree and got the same
23 failures (854 tests vs. 859, the 5-test difference being KRMA-221's new cases) — so these are
pre-existing, not a regression from KRMA-221's linear-gradient-mask work. Failure symptoms (timeouts
