---
id: KRMA-160
title: "Fix(KRMA-155): commit missing Settings entry point so Always-dark-mode toggle is reachable"
type: bug
status: done
priority: urgent
creation_provenance:
...
updated: 2026-09-10T12:53:43.727Z
parent: KRMA-155
order: ypcdtnr1
board: product
---
...
let a user actually open Settings and toggle **Always dark mode**, so KRMA-155's
fix (`LumoWindowAppearanceController`) is reachable in the shipped app.

## Context

Counterpoint verification of KRMA-155 (commit `d67e322`) found that the committed
...
Separately, a clean checkout of HEAD does not even compile — see [[KRMA-161]] for
...
- [ ] From a clean checkout, a user can open Settings, toggle "Always dark mode",
      and see the main window/app shell update live per KRMA-155's acceptance
...
(KRMA-152/153/154 family) since the untracked `LumoSettingsView.swift`,
