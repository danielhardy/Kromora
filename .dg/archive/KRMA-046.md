...
updated: 2026-09-10T12:53:36.870Z
depends_on:
  - KRMA-045
  - KRMA-013
estimate: 5
...
- `dg validate`: OK (same pre-existing warnings: runner-model, KRMA-044 context completeness)

**Verification commit:** 99163f1 — fix(KRMA-046): make canvas pan redraw and stop pinch from opening undo groups
