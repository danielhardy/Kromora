...
updated: 2026-09-10T12:53:35.366Z
depends_on:
  - KRMA-013
  - KRMA-014
estimate: 3
...
- `docs/TESTING.md` gives a concrete, repeatable capture recipe (cold/warm launch, photo switch, slider interactive vs. settled, histogram, export) and states thresholds as targets to validate, not met claims — matches the "out of scope: claims that targets are met before profiling" constraint.
