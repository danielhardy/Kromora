...
updated: 2026-09-10T12:53:41.810Z
order: 8s82axy1
board: product
commits:
  - 87da92f
...
KRMA-094 addressed black frames for explicit zoom, fill, comparison zoom, panning, and pinch
...
as a regression against KRMA-094 and verify the interaction across the navigation, render-resolution,
...
Start from the KRMA-094 fix and compare the current render/presentation path for higher zooms,
...
- Full suite `swift test` — 608 passed, 13 skipped, **0 failures** (the KRMA-132 timing-sensitive
