...
updated: 2026-09-10T12:53:45.062Z
order: d3qs828v
board: product
---
...
**Relates to:** KRMA-178 (multi-open dialog) — this is about what happens *after* the photos are in.
...
- **Stop clearing on open.** `openImageDialog()` (KRMA-178 path) and other single-import helpers
