...
updated: 2026-09-10T12:53:37.962Z
order: tnwjl0qe
board: product
---

Parent: KRMA-025 (verification finding, non-blocking)

## Context

KRMA-025 replaced `LightAdjustments.existingNodeRepresentation`-based rendering with a native
...
KRMA-025's verification fix to keep that fix minimal and localized.
