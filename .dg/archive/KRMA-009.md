...
updated: 2026-09-10T12:53:35.029Z
depends_on:
  - KRMA-007
estimate: 5
order: qco6wtu3
...
- `dg validate` — OK, same two pre-existing warnings (pickup runner model name, KRMA-005 context completeness) unrelated to this issue.
