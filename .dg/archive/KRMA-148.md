...
updated: 2026-09-10T12:53:42.923Z
depends_on:
  - KRMA-080
  - KRMA-091
estimate: 3
...
The Light inspector's master RGB curve already has model operations for adding, moving, and removing normalized points, and KRMA-080/KRMA-091 established the live-preview interaction path. Today, clicking an empty location does not create a handle during the drag; the user must add a point first, then begin a second drag.
