...
updated: 2026-09-10T12:53:35.973Z
depends_on:
  - KRMA-025
  - KRMA-026
  - KRMA-027
...
- `dg validate` — OK, only pre-existing warnings (agents.pickup.runner model name, KRMA-023/066 context completeness).
...
- 2026-08-31T20:11:39.812Z: Verified KRMA-028 Light inspector: found and fixed two bugs (tone-curve keyboard-add-first-point guard, Cmd+Shift+Z falling back to undo). swift test/release build/git diff --check/dg validate all clean.
