...
updated: 2026-09-10T12:53:38.215Z
order: 4lvyuizk
board: product
commits:
  - 70bdc59
...
- [ ] Real RAW pointer-to-present measurements satisfy KRMA-072 on at least 24 MP and 40-60 MP files.
...
- Out of scope for this ticket, tracked correctly elsewhere: the AC "Real RAW
  pointer-to-present measurements satisfy KRMA-072" and the progressive-frame
  evidence-backed-exception AC both require the hardware measurement harness that is
  KRMA-072's own deliverable (status: ready, depends_on already includes KRMA-070).
  ...
  latestRequest coalescing (KRMA-069, commit 389ba63), which this diff builds on
...
- 2026-08-31T23:14:52.380Z: Independent verification passed: restore-before-apply covers every RAWDevelopSettings property, session correctly actor-confined and invalidated. Added regression test for the restore/apply leak risk (commit 70bdc59). Hardware-measurement ACs deferred to KRMA-072 as designed.
