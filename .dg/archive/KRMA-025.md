...
updated: 2026-09-10T12:53:35.825Z
depends_on:
  - KRMA-024
estimate: 5
order: 1q7hkg4c
...
**Non-blocking finding filed separately:** KRMA-066 (backlog, `verification` label, parent KRMA-025) — `LightAdjustments.existingNodeRepresentation` is now dead code (zero callers repo-wide) despite a doc comment claiming it's kept for migration/diagnostic use. Cleanup only, not folded into this fix to keep it minimal.
...
- 2026-08-31T19:37:10.030Z: Independent verification passed after fixing a tone-curve monotonicity bug (contrast/highlights/shadows combined values could invert tones locally). Fix + regression test in 8934fee. Non-blocking cleanup filed as KRMA-066.
